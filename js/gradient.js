...
class GradientBackground {
  constructor(sceneManager) {
    ...
    this.uniforms = {
      ...
      uColor3: { value: new THREE.Vector3(0.549, 0.161, 0.400) },
      uColor4: { value: new THREE.Vector3(0.039, 0.055, 0.153) },
      uColor5: { value: new THREE.Vector3(0.643, 0.161, 0.145) },
  ...
  constructor() {
    ...
    this.colorSchemes = {
      1: {
        ...
        color3: new THREE.Vector3(0.549, 0.161, 0.400),
        color4: new THREE.Vector3(0.039, 0.055, 0.153),
        color5: new THREE.Vector3(0.643, 0.161, 0.145),
